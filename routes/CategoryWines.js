...
//Agregar un tipo de vino
router.post('/add', auth.authenticateToken, checkRole.checkRole,(req, res, next) => {
    let Category = req.body;
    let query = "INSERT INTO CategoryWines (Tipo) VALUES (?)";
...
router.get('/get', auth.authenticateToken, (req, res, next) => {
    var query = "SELECT * FROM CategoryWines";
...
//Hacer cambios en un tipo de vino YA existente
router.patch('/update', auth.authenticateToken, (req, res, next) => {
    let product = req.body;
    var query = "UPDATE CategoryWines SET Tipo=? WHERE id=?";
